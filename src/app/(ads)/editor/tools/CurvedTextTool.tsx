// src/app/editor/tools/CurvedTextTool.tsx
'use client';
...
const curvePresets = [
  ...
  { id: 'wave', name: 'Onda Suave', path: 'M10,60 Q60,10 110,60 T190,60' },
  {
    id: 'circle',
    name: 'Círculo',
    path: 'M 50,60 A 50,50 0 1,1 150,60 A 50,50 0 1,1 50,60',
  },
];
